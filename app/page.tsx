    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow overflow-x-hidden">
        <div className="md:snap-y md:snap-mandatory md:h-screen md:overflow-y-scroll">
          <Element name="home" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedHomeSection t={t} />
          </Element>
          <Element name="about" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedAboutSection t={t} />
          </Element>
          <Element name="skills" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedSkillsSection t={t} />
          </Element>
          <Element name="projects" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedProjectsSection t={t} />
          </Element>
          <Element name="services" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedServicesSection t={t} />
          </Element>
          <Element name="testimonials" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedTestimonialsSection t={t} />
          </Element>
          <Element name="contact" className="min-h-screen md:snap-start flex items-center justify-center py-16 md:py-0">
            <TypedContactSection t={t} />
          </Element>
        </div>
      </main>
